  ...
  <div class="screen-shell screen-result">
    <section class="panel screen-panel result-screen-panel scene-panel">
      <div class="screen-stack result-panel-stack">
        ...
        <div v-if="isRankingMode" class="form-field-stack result-name-panel">
        ...
        <p v-if="!isRankingMode" class="result-field-hint">연습 모드는 기록을 저장하지 않아요.</p>

        <div class="screen-actions screen-actions-center">
          <button v-if="isRankingMode" class="primary-button" :disabled="!canRegister" @click="submitRegister">랭킹에 남기기</button>
